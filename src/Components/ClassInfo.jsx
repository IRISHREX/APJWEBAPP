...
import './ClassInfo.css'; // Import the CSS file
  ...
  return (
    <FeatureComingSoonOverlay>
      <div className="class-info-container">
        <Typography variant="h4" className="feature-text">
          FEATURE COMING SOON...
        </Typography>
        ...
        <div className="slider-section">
          ...
          <div className="timing-container">
            {classTimings.map((classTime) => (
              <div key={classTime.className} className="timing-item">
                <Typography variant="subtitle1">{classTime.className}</Typography>
        ...
        <div className="syllabus-section">
          ...
          <div className="syllabus-card-container">
            {syllabusData.map((item) => (
              <Card key={item.className} className="syllabus-card">
                <CardContent>
                  <Typography variant="h6">{item.className}</Typography>
                  <Typography>{item.syllabus}</Typography>
                </CardContent>
