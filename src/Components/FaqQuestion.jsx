...
export const questions = [
    {
        ...
        answer : "We offer coaching for Entrance exams of courses such as BA LLB (5 years), BA (all courses), and B.Com.",
    },
    {
        id: 2,
        question: "Which universities should I primarily focus on getting into?",
        answer: "We encourage the students to pursue a course in the Top tier Universities in our nation such as Aligarh Muslim University (AMU), Jamia Millia Islamia (JMI), Calcutta University (CU), Presidency University (PU), and Delhi University (DU) also for the Universities which are dedicated to admitting students through an universal Entrance test such as CUET, MHCET or Independent entrance examinations conducted by Universities across the nation.",
    },
    {
        id: 3,
        question: "How can I take admission in your coaching institution?",
        answer: "You can take admission by contacting us via WhatsApp at 6294494027 or by calling us at 7029928412.",
    },
    {
        id: 4,
        question: "Who is eligible to join, and what are the eligibility criteria for admission?",
        answer: "Any student who has already completed their +2 (higher secondary) or is currently pursuing their +2 session and wishes to pursue higher studies at any of such top-tier Universities or they are looking out for a well rounded coaching and guidance for Entrance tests could enroll themselves in our coaching institution.",
    },
    {
        id: 5,
